    ...
    return (
      <div>
        ...
        <div className={styles.container}>
          <button className={styles.leftnav} onClick={this.handleLeftNav}>
            &#60;
          </button>
          ...
          <button className={styles.rightnav} onClick={this.handleRightNav}>
            &#62;
          </button>
        </div>
        <div className={styles.footer}>
          <div className={styles.columnTitle}>
            <div style={{ marginBottom: "15px" }}>Airbnb</div>
          ...
          <div className={styles.columnTitle}>
            <div style={{ marginBottom: "15px" }}>Discover</div>
          ...
          <div className={styles.columnTitle}>
            <div style={{ marginBottom: "15px" }}>Hosting</div>
          ...
          <div className={styles.columnTitle}>
            <a
              ...
              href="http://www.facebook.com/PLACEHOLDER"
            >
              <img
                alt="follow me on facebook"
                height="25px"
                width="25px"
                src="http://www.bikethomson.com/wp-content/themes/bike_thomson/images/fb.png"
              />
            </a>
            <a
              target="_blank"
              ...
              href="http://www.twitter.com/PLACEHOLDER"
            >
              <img
                style={{ color: "#767676" }}
                ...
                height="25px"
                width="25px"
                src="http://icons.iconarchive.com/icons/custom-icon-design/mono-general-3/32/twitter-icon.png"
              />
            </a>
            <a
              target="_blank"
              style={{ color: "#767676", marginBottom: "15px" }}
              title="follow me on Instagram"
              href="http://www.instagram.com/PLACEHOLDER"
            >
              <img
                alt="follow me on instagram"
                height="25px"
                width="25px"
                src="http://icons.iconarchive.com/icons/iconsmind/outline/32/Instagram-icon.png"
              />
            </a>
